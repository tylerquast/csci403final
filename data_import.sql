...
ALTER TABLE flights ADD CONSTRAINT constraint_fkey FOREIGN KEY (airline_id) REFERENCES airline (id);
ALTER TABLE flights ADD CONSTRAINT constraint_fkey FOREIGN KEY (origin_airport_id) REFERENCES airport (id);
ALTER TABLE flights ADD CONSTRAINT constraint_fkey FOREIGN KEY (dest_airport_id) REFERENCES airport (id);